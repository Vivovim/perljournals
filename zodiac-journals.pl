...
## Change database table name for extra results. Be sure that table contains moon data!!!!!.
...
my @zodiac = qw(Aries Taurus Gemini Cancer Leo Virgo
                Libra Scorpio Sagittarius Capricorn Aquarius Pisces);

my $index = int($mo / 30) % 12;

my $sign  = $zodiac[$index];

# say "The Moon is in $sign at longitude $mo\n";
...
my @zodiac2 = qw(Aries Taurus Gemini Cancer Leo Virgo
                Libra Scorpio Sagittarius Capricorn Aquarius Pisces);
...
my $search = $picks{$answer};


my $fileo = $search . "-" . "Journal.txt";


open (FO, ">>$fileo") || die "Sorry dave file $fileo failed $!";
...
# my $timex = "$hour:$minute:$second";
my $tz_name = "America/Phoenix";


# my $time2 = $time1 . "T" . $timex;
...
print FO "Sign: $signx\n";
print FO "Recid: $row[0]\n";
print FO "Date: $row[1]\n";
print FO "Time: $row[2]\n";
print FO "Duration: $row[3]\n";
# print FO "$row[4]\n";
# print FO "$row[5]\n";
print FO "Category: $row[6]\n";
print FO "Moon Age: $row[10]\n";
print FO "$row[7]\n$row[8]\n";
}
