...
# change ip address to your db server hostname
# Change username and password to your username & Password
...
# print "Total write time: $writeTime1 minutes\n";
# print "The average is: $var2 minutes\n";
# print "The average wc is: $var3\n";
# print "The average WPM is: $wpm2\n";
